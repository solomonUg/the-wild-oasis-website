...
export default async function Page() {
  ...
  return (
    <div className="w-full flex justify-center mt-14 mb-60">
      <div className="w-[95%]">
        <section className="w-full flex flex-col-reverse md:flex-row">
          <div className=" w-full md:w-[65%] flex flex-col justify-center py-4 md:pr-16">
            <h1 className="text-4xl mb-10 text-accent-400 font-medium">
              Welcome to The Wild Oasis
            </h1>
            <div className="space-y-8 lg:text-lg">
              <p>
        ...
        <section className="w-full flex flex-col md:flex-row mt-32 gap-x-16">
          <div className=" w-full md:w-[35%] relative">
            <Image
              src={about2}
              alt="Family sitting around a fire pit in front of cabin"
          ...
          <div className=" w-full md:w-[65%] flex flex-col justify-center py-4">
            <h1 className="text-4xl mb-10 text-accent-400 font-medium">
...
// <div className="w-full flex justify-center mt-14 mb-60">
//     <div className="w-[95%] grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
